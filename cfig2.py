...
points1= np.genfromtxt("stt_a100_n15.csv", delimiter=",")
points2= np.genfromtxt("stt_n15_a100_T0.csv", delimiter=",")
points3= np.genfromtxt("stt_n15_a100_sig0.csv", delimiter=",")
...
points4= np.genfromtxt("snn_a100_n15.csv", delimiter=",")
points5= np.genfromtxt("snn_n15_a100_T0.csv", delimiter=",")
points6= np.genfromtxt("snn_n15_a100_sig0.csv", delimiter=",")
